...
annot_dir = '/media/icml/My_Passport/datasets/mpii_human_pose_v1/annot'
img_dir = '/media/icml/My_Passport/datasets/mpii_human_pose_v1/images'
...
class MPII:
    def __init__(self):
        ...
        t_part = train_f['part'][()]  # (22246,16,2)
        t_visible = train_f['visible'][()]
        t_normalize = train_f['normalize'][()]
        t_imgname = [x.decode('UTF-8') for x in train_f['imgname']]
        ...
        v_imgname = [x.decode('UTF-8') for x in val_f['imgname']]
        # v_imgname = [val_f['imgname'][i].decode('UTF-8') for i in range(len(self.v_center))]
    ...
    def getAnnots(self, idx):
        ...
        '''
        return self.imgname[idx], self.part[idx], self.visible[idx], self.center[idx], self.scale[idx], self.normalize[
            idx]
